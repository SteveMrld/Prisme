          ...
          <div style={{
            ...
            <div style={{ padding:'6px 14px', display:'flex', gap:'12px', flexWrap:'wrap', borderBottom:'1px solid rgba(255,255,255,0.04)', background:'rgba(255,255,255,0.02)' }}>
              ...
              <span style={{ fontFamily:'DM Mono,monospace', fontSize:'9px', color:'rgba(255,255,255,0.5)' }}>
                🇫🇷 France : <strong style={{ color:franceColor }}>{zone.france}/10</strong>
              </span>
            ...
            <div style={{ padding:'6px 14px 10px', display:'flex', justifyContent:'space-between', alignItems:'center', borderTop:'1px solid rgba(255,255,255,0.04)' }}>
              ...
              <div style={{ display:'flex', gap:'5px' }}>
                {Array.from({length:total}).map((_,i) => (
                  <div key={i} onClick={() => call('goToZone', i)} style={{
              ...
              <div style={{ display:'flex', gap:'6px' }}>
                <button onClick={() => call('prevZone')} style={{
                ...
                <button onClick={() => call(idx === total-1 ? 'goToZone' : 'nextZone', idx === total-1 ? 0 : undefined)} style={{
                  background:'none', border:`1px solid ${col}66`,
                  color:col, fontFamily:'DM Mono,monospace',
                  fontSize:'8px', letterSpacing:'2px', textTransform:'uppercase',
                  padding:'6px 12px', cursor:'pointer'
                }}>{idx === total-1 ? '↺ Début' : 'Suiv. →'}</button>
              </div>
            </div>
          </div>
        </div>
