  ...
  return (
    ...
    >
      <div className="soara-article">
        ...
        <blockquote style={{ margin: "40px 0", padding: "24px 32px", background: "#1A2744", color: "#c8bfaa", fontFamily: "Georgia, serif", fontSize: "16px", fontStyle: "italic", lineHeight: "1.75", borderRadius: "2px" }}>
          «&nbsp;Farcical.&nbsp;»<br />
