  ...
  return (
    <GrandFormatLayout slug="dette-souveraine" author="Steve Moradel" authorRole=""
      ...
      <div className="soara-article">
        ...
        <h2>L'empire qui travaille pour <em>ses créanciers</em></h2>
        ...
        <h2>Ce que la dette <em>empêche</em></h2>
        ...
        <p>Ce que la dette empêche ne figure dans aucun bilan officiel. Il s'agit d'un manque&nbsp;: les hôpitaux qu'on n'a pas construits, les réseaux ferrés qu'on n'a pas rénovés, les laboratoires de recherche publique qu'on n'a pas financés. La dette ne détruit pas seulement de la richesse présente, elle ampute la capacité à en produire dans le futur. C'est ce que les économistes appellent l'effet d'éviction&nbsp;: chaque euro consacré au service de la dette est un euro soustrait à l'investissement productif. La France, en 2025, consacre à ses créanciers une somme supérieure à ce qu'elle dépense pour la transition énergétique, la défense ou l'enseignement supérieur pris séparément.</p>
        ...
        <p>Il existe aussi une géographie de la contrainte. Les pays du Sud global ont longtemps porté seuls le regard condescendant des institutions de Bretton Woods sur leur gestion financière. Les plans d'ajustement structurel imposés par le FMI au Ghana, à l'Argentine ou à la Zambie ont fait l'objet d'analyses critiques exhaustives. Mais la dynamique qui frappe aujourd'hui les économies avancées n'est pas fondamentalement différente&nbsp;: c'est la même logique de la dette qui se substitue à la politique, le même rétrécissement de l'espace démocratique sous la pression des marchés. La différence, c'est que personne ne l'appelle ajustement structurel.</p>

        <h2>L'angle mort&nbsp;: <em>ce qu'on choisit de ne pas percevoir</em></h2>
        ...
        <p>Il existe une autre catégorie d'angles morts&nbsp;: les dépenses fiscales. En France, elles représentent plus de 80 milliards d'euros annuels, niches, crédits d'impôt, exonérations dont l'efficacité économique n'a jamais été véritablement évaluée. Elles s'accumulent par sédimentation législative, chaque gouvernement ajoutant les siennes sans supprimer les précédentes. C'est de la dépense publique déguisée en manque à gagner fiscal. Et comme elle n'apparaît pas dans le budget, personne ne vote pour la supprimer. Le débat public s'épuise à discuter d'ajustements à la marge, quelques centaines de millions ici ou là, tandis que des dizaines de milliards dorment, intouchables, dans des dispositifs que leurs bénéficiaires ont appris à rendre invisibles.</p>
        <p>La critique la plus sérieuse que l'on puisse adresser à la gestion de la dette française n'est pas technique. Elle est politique. Les instruments existent. Les leviers sont connus. Ce qui manque, c'est la volonté de les activer contre des intérêts organisés qui ont appris à neutraliser toute tentative de réforme. En ce sens, la dette n'est pas le symptôme d'une incompétence collective. Elle est le produit d'un rapport de forces.</p>

        <h2>Une question de <em>souveraineté</em></h2>
        ...
        <p>La souveraineté budgétaire n'est pas qu'une abstraction comptable. Elle détermine le périmètre réel de la décision politique. Quand les taux d'intérêt remontent de 100 points de base, la France dépense mécaniquement plusieurs milliards supplémentaires en service de la dette, sans qu'aucun gouvernement, aucun parlement, aucun citoyen n'ait eu à se prononcer. La décision appartient à la BCE, aux marchés obligataires, aux agences de notation. Ce sont des institutions non élues qui fixent, en partie, le cadre dans lequel s'exerce la démocratie française. Ce renversement de légitimité mérite d'être nommé clairement&nbsp;: il s'agit bien d'une forme de dépossession, consentie par accumulation de déficits successifs.</p>
        <p>Les pays émergents qui ont traversé des crises de dette souveraine, l'Argentine en 2001, la Grèce en 2010, ont vécu cette réalité de façon brutale&nbsp;: l'État contraint de négocier avec ses créanciers la nature même de sa politique sociale, salariale, éducative. La France n'en est pas là. Mais la direction empruntée depuis quarante ans pointe dans ce sens. Le débat démocratique ne devrait pas seulement porter sur la réduction du déficit. Il devrait porter sur ce que l'accumulation de dette transfère, progressivement et silencieusement, hors du champ de la décision collective.</p>

        <h2>La dette <em>invisible</em></h2>
        ...
        <h2>Un choix, <em>pas une fatalité</em></h2>
        ...
        <p>Des trajectoires alternatives ont pourtant existé. La Suède, au début des années 1990, a fait face à une crise financière et budgétaire d'une sévérité comparable à celle de la Grèce en 2010. Elle a choisi l'ajustement, douloureux, rapide, conduit avec un large consensus politique et syndical. En moins d'une décennie, elle avait transformé un déficit de 12&nbsp;% du PIB en excédent budgétaire. Elle dispose aujourd'hui de l'une des finances publiques les plus solides d'Europe. Ce n'est pas un miracle nordique. C'est le résultat d'un choix de société, délibéré et assumé.</p>
        <p>La comparaison ne vise pas à plaider pour l'austérité indifférenciée. Elle vise à démontrer que la contrainte budgétaire n'est pas une loi naturelle, c'est le résidu de décisions accumulées. Et que d'autres décisions sont possibles, à condition de ne pas confondre l'inévitable et le confortable. La question n'est plus de savoir si la France devra ajuster ses finances publiques. Elle est de savoir si cet ajustement se fera dans le cadre d'un projet politique choisi, ou sous la pression de marchés que personne n'aura su anticiper.</p>
