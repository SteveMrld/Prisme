...
export default function ArticleLayout({
  ...
  return (
    <>
      ...
      <div className={styles.shareBar} style={{display:'none'}}>
        ...
        <div className={styles.shareBtns}>
          ...
          <a className={styles.shareBtn} href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(typeof window !== 'undefined' ? window.location.href : '')}&text=Lu%20sur%20Confins`} target="_blank" rel="noopener">
          ...
          <a className={styles.shareBtn} href={`https://wa.me/?text=${encodeURIComponent('Lu sur Confins : ' + (typeof window !== 'undefined' ? window.location.href : ''))}`} target="_blank" rel="noopener">
